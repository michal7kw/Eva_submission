...
#===============================================================================
# SCRIPT: volcano_plot_publication.sh
# PURPOSE: Generate publication-ready volcano plots from DESeq2 results
#
# DESCRIPTION:
# Creates high-quality volcano plots in two versions:
#   1. With gene labels (top significant genes labeled)
#   2. Without gene labels (clean version for overview)
#
# EXPECTED INPUTS:
# - DESeq2 results: results/05_deseq2/deseq2_results_TES_vs_GFP.txt
#
# EXPECTED OUTPUTS:
# - results/05_deseq2/plots/volcano_publication_labeled.pdf
# - results/05_deseq2/plots/volcano_publication_labeled.png
# - results/05_deseq2/plots/volcano_publication_clean.pdf
# - results/05_deseq2/plots/volcano_publication_clean.png
#
# USAGE:
# sbatch scripts/volcano_plot_publication.sh
#===============================================================================
...
#SBATCH --error="./logs/volcano_plot.err"
#SBATCH --output="./logs/volcano_plot.out"
...
echo "=== Generating Publication-Ready Volcano Plots ==="
echo "Timestamp: $(date)"
...
# Create R script for publication-ready volcano plots
cat > ${OUTPUT_DIR}/volcano_publication.R << 'EOF'
#!/usr/bin/env Rscript
...
Rscript ${OUTPUT_DIR}/volcano_publication.R

# Check outputs
echo ""
echo "=== Checking output files ==="

for suffix in labeled clean minimal; do
    for ext in pdf png; do
        file="${OUTPUT_DIR}/volcano_publication_${suffix}.${ext}"
        if [[ -f "$file" ]]; then
